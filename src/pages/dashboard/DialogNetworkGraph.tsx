...
const DialogNetworkGraph = (props: DialogInfoProps) => {
    ...
    const { currentData: resultNetworkGraph, loadingNetworkGraph } = GetNetworkGraph(params?.campaign, params?.platformId, params?.date, params?.endDate, params?.period, params?.previousDate, params?.previousEndDate, keywordId, messageId, !!reportNo);
